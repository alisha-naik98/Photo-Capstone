                                                ...
                                                <div class="comment-reply-form">
                                                    ...
                                                    { message ? <div className={`alert ${postCreated ? 'alert-success':'alert-danger'}`}>{message}</div> : ''}
                                                        <div class="comment-form-author control-group">
                                                            <div class="controls">
                                                                <input id="author_name" name="author_name" type="text" onChange={this.handleOnChange} value={author_name} size="40" aria-required="true" />
                                                            </div>
                                                        ...
                                                        <div class="comment-form-email control-group">
                                                            <div class="controls">
                                                                <input id="email" name="email" type="text" onChange={this.handleOnChange} value={userEmail} size="40" aria-required="true" />
                                                            </div>
                                                        ...
                                                        <div class="comment-form-comment control-group">
                                                            <div class="controls">
                                                                <textarea id="content" name="content" onChange={this.handleOnChange} value={content} cols="50" rows="8" aria-required="true" placeholder="Your comment here..">
                                                                </textarea>
                                                            </div>
                                                        </div>
